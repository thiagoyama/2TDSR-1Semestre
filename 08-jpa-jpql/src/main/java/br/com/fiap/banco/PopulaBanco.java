...
public class PopulaBanco {
	...
	public static void main(String[] args) throws CommitException {
		 ...
		 */
		Calendar dtSaida1 = new GregorianCalendar(2023, Calendar.JANUARY, 23);
		Pacote pacote1 = new Pacote("Porto de Galinhas", dtSaida1, 7, 2000f, transporte1);
		
		Calendar dtSaida2 = new GregorianCalendar(2023, Calendar.AUGUST, 20);
		Pacote pacote2 = new Pacote("Natal", dtSaida2, 10, 2300f, transporte1);
		
		Calendar dtSaida3 = new GregorianCalendar(2024, Calendar.AUGUST, 13);
		Pacote pacote3 = new Pacote("Bonito", dtSaida3, 8, 500f, transporte2);
		
		Calendar dtSaida4 = new GregorianCalendar(2024, Calendar.JANUARY, 23);
		 ...
		 */
		Reserva reserva1 = new Reserva(10,LocalDate.of(2023, 1, 15),pacote1,cliente2);
		
		Reserva reserva2 = new Reserva(10,LocalDate.of(2025, 8, 20),pacote4,cliente5);
